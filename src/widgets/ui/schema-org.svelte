			...
			// --- 5. FAQ (Вопросы-ответы для сниппета) ---
			{
				...
				mainEntity: [
					...
					},
					{
						...
						acceptedAnswer: {
							"@type": "Answer",
							text: "Да, у нас работает честный поминутный биллинг. Важно: при простой остановке (Stop) сервера оплата продолжает списываться, так как видеокарта остается зарезервированной за вами. Чтобы полностью остановить списания, сервер необходимо удалить (Terminate)."
						}
					},
					{
						"@type": "Question",
