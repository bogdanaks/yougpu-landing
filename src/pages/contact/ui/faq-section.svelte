<script lang="ts">
	...
	const faqs = [
		...
		},
		{
			...
			a: "Да, при нажатии «Остановить» (Stop) данные на диске сохраняются в безопасности. Однако обратите внимание: в этом режиме видеокарта остается зарезервированной за вами (для гарантии доступности), поэтому списание средств продолжается по полному тарифу. Чтобы остановить списания, инстанс необходимо удалить (Terminate) — в этом случае данные удаляются безвозвратно."
		},
		{
